package com.d121201055.taskreminder.adapter
...
import com.d121201055.taskreminder.fragments.HistoryFragmentDirections
import com.d121201055.taskreminder.fragments.HomeFragmentDirections
...
class TaskAdapter:RecyclerView.Adapter<TaskAdapter.TaskAdapterViewHolder>() {
    ...
    override fun onBindViewHolder(holder: TaskAdapterViewHolder, position: Int) {
        ...
        if (currentTask.status.equals("Belum Selesai")) {
